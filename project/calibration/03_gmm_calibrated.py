...
if __name__ == '__main__':
    S = vrow(np.load('..\\data\\03_gmm_scores.npy'))
    L = np.load('..\\data\\03_gmm_labels.npy')
    ...
    np.save('..\\data\\03_gmm_scores_c_mvg.npy', logRatioCumulative)
    np.save('..\\data\\03_gmm_labels_c_mvg.npy', cumulativeLabels)

    actualDCF, minDCF = bayer_error_plots(logRatioCumulative, cumulativeLabels)
    np.save('..\\data\\03_gmm_actualDCF_c_mvg.npy', actualDCF)
    ...
    np.save('..\\data\\03_gmm_scores_c_linear-log.npy', logRatioCumulative)
    np.save('..\\data\\03_gmm_labels_c_linear-log.npy', cumulativeLabels)

    actualDCF, minDCF = bayer_error_plots(logRatioCumulative, cumulativeLabels)
    np.save('..\\data\\03_gmm_actualDCF_c_linear-log.npy', actualDCF)