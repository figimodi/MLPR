...
if __name__ == '__main__':
    TPR_log = np.load('..\\calibration\\data\\01_log-reg_TPR.npy')
    FPR_log = np.load('..\\calibration\\data\\01_log-reg_FPR.npy')
    FNR_log = np.load('..\\calibration\\data\\01_log-reg_FNR.npy')
    actualDCF_log = np.load('..\\calibration\\data\\01_log-reg_actualDCF.npy')
    minDCF_log = np.load('..\\calibration\\data\\01_log-reg_minDCF.npy')

    TPR_svm = np.load('..\\calibration\\data\\02_svm_TPR.npy')
    FPR_svm = np.load('..\\calibration\\data\\02_svm_FPR.npy')
    FNR_svm = np.load('..\\calibration\\data\\02_svm_FNR.npy')
    actualDCF_svm = np.load('..\\calibration\\data\\02_svm_actualDCF.npy')
    actualDCF_svm_c_mvg = np.load('..\\calibration\\data\\02_svm_actualDCF_c_mvg.npy')
    actualDCF_svm_c_linear_log = np.load('..\\calibration\\data\\02_svm_actualDCF_c_linear-log.npy')
    minDCF_svm = np.load('..\\calibration\\data\\02_svm_minDCF.npy')

    TPR_gmm = np.load('..\\calibration\\data\\03_gmm_TPR.npy')
    FPR_gmm = np.load('..\\calibration\\data\\03_gmm_FPR.npy')
    FNR_gmm = np.load('..\\calibration\\data\\03_gmm_FNR.npy')
    actualDCF_gmm = np.load('..\\calibration\\data\\03_gmm_actualDCF.npy')
    minDCF_gmm = np.load('..\\calibration\\data\\03_gmm_minDCF.npy')
